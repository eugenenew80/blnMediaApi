...
public class LastLoadInfoServiceImpl extends AbstractEntityService<LastLoadInfo> implements LastLoadInfoService {
	...
	public void updateLastDataLoadDate(List<MinuteMeteringDataRaw> minuteMeteringData) {
		Map<Pair<String, String>, List<MinuteMeteringDataRaw>> map = minuteMeteringData
			.stream()
